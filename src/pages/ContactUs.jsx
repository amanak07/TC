      ...
      <div className="mb-10 mt-24">
        ...
        <div className="w-full flex flex-col items-center justify-center mt-10 mb-10">
          ...
          <div className="w-full flex flex-col items-center justify-center">
            <p>
              <a
                href="https://www.facebook.com/profile.php?id=61556718552631&mibextid=LQQJ4d"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/travelll_crew/profilecard/?igsh=MWd6eWNxajc2ZmM1OQ=="
                target="_blank"
                rel="noopener noreferrer"
                className="pl-5 pr-5"
              >
